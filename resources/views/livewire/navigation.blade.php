          ...
          <div x-data="{open:false}" class="relative ml-3">
            ...
            <div x-show="open" x-on:click.outside="open=false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
              ...
              @if (Route::has('login'))
                  ...
                  @else
                      <a href="{{ route('login') }}" class="hover:bg-purple-700 hover:text-white hover:text-lg block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Log in</a>
                      @if (Route::has('register'))
                          <a href="{{ route('register') }}" class="hover:bg-purple-700 hover:text-white hover:text-lg block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Register</a>
                      @endif
                  @endauth
              </div>
          @endif
