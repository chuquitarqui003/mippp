            ...
            <table class="w-full divide-y divide-gray-200 table-auto">
              <thead class="bg-indigo-500 text-white">
                <tr class="text-left text-xs font-bold  uppercase">
                  ...
                  <td scope="col" class="px-6 py-3">Marca</td>
                  <td scope="col" class="px-6 py-3">Modelo</td>
                  <td scope="col" class="px-6 py-3">Cantidad</td>
                  <td scope="col" class="px-6 py-3">FechaCompra</td>
              ...
              <tbody class="divide-y divide-gray-200">
                ...
                <tr class="text-sm font-medium text-gray-900">
                  ...
                  <td class="px-6 py-4">{{$item->fechaCompra}}</td>
                  <td class="px-6 py-4">{{$item->importe}}</td>
                  <td class="px-6 py-4">{{$item->supplier_id  }}</td>
                    {{--@if ($item->supplier_id)
            ...
            Swal.fire({
              ...
              confirmButtonText: 'Yes, delete it!'
                ...
                if (result.isConfirmed) {
                    //alert("del");
                    Livewire.emitTo('crud-article','delete',id);
                    Swal.fire(
                        'Deleted!',
