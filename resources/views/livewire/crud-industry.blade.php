    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="lg:ml-40 ml-10 space-x-8">
                    ...
                    @if($isOpen)
                        @include('livewire.industry-create')
                    @endif
            </div>
        </div>
            ...
            <table class="w-full divide-y divide-gray-200 table-auto">
              <thead class="bg-indigo-500 text-white">
                <tr class="text-left text-xs font-bold  uppercase">
                  ...
                  <td scope="col" class="px-6 py-3">industria_nombre</td>
                  <td scope="col" class="px-6 py-3">industria_ruc</td>
                  <td scope="col" class="px-6 py-3">industria_direccion</td>
                  <td scope="col" class="px-6 py-3">industria_telefono</td>
                  <td scope="col" class="px-6 py-3">industria_correo</td>
                  <td scope="col" class="px-6 py-3">student_id</td>
              ...
              <tbody class="divide-y divide-gray-200">
                ...
                <tr class="text-sm font-medium text-gray-900">
                  ...
                  <td class="px-6 py-4">{{$item->industria_nombre}}</td>
                  <td class="px-6 py-4">{{$item->industria_ruc}}</td>
                  <td class="px-6 py-4">{{$item->industria_direccion}}</td>
                  <td class="px-6 py-4">{{$item->industria_telefono}}</td>
                  <td class="px-6 py-4">{{$item->industria_correo}}</td>
            ...
            Swal.fire({
              ...
              confirmButtonText: 'Yes, delete it!'
                ...
                if (result.isConfirmed) {
                    //alert("del");
                    Livewire.emitTo('crud-industry','delete',id);
                    Swal.fire(
                        'Deleted!',
